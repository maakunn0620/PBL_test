            ...
            <form method="POST" action="update">
                ...
                <table class="form" width="1000px">
                    ...
                    @foreach ($sp_company as $sp_companys)
                        ...
                        <tr>
                            <th>求人票PDF</th>
                            <td><input type="text" name="pdf" id="pdf" value="{{$sp_companys->pdf}}" size="40"></td>
                        </tr>
                        <tr>
                            <th>所在地</th>
                            <td><input type="text" name="address" id="address" value="{{$sp_companys->address}}" size="40"></td>
                        </tr>
                        <tr>
                            <th>会社HP</th>
                            <td><input type="text" name="company_url" id="HP" value="{{$sp_companys->company_url}}" size="40"></td>
                        </tr>
                        <tr>
                            <th>コメント</th>
                            <td><input type="text" name="comment" id="cment" value="{{$sp_companys->cment}}" size="40"></td>
                        </tr>
                        <tr>
                            <td><input type="submit" class="bt" value="更新"></td>
                        </tr>
                    @endforeach
                </table>
        @endisset
